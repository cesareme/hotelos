...
const LOTS = {
  ...
  4: [["4-B · Punto de venta, compras e inventario", (r) => /Pos|pos\/|CashClosure|Fnb|Inventory|Procurement|PuntoVenta|ComprasInventario/.test(r)], ["4-C · Personal, seguridad, energía y activos", (r) => /Workforce|Safety|Energy|Assets/.test(r)], ["4-A · Pisos y mantenimiento", () => true]],
  ...
  // Tanda 6 (Finanzas): 6-C absorbed Contabilidad (diario, mayor, plan, ajustes, gestoría) and PyG; 6-D is Proveedores,
  // gastos e inmovilizado; 6-F is USALI y cuentas anuales; the TPV / cierre de caja lot (6-E) lives in waves 4 (4-B) and 2.
  6: [["6-A · Facturación (centro, folios, rectificativas, enrutado)", (r) => /billing\/|invoicing\/|Facturacion|FolioRouting/.test(r)], ["6-C · Contabilidad y estados contables (diario, mayor, plan, ajustes, gestoría, balance, PyG, sumas y saldos, cierre, tipos de cambio)", (r) => /accounting\/|BalanceSheet|TrialBalance|ExchangeRates|YearEndClose|ProfitAndLoss|EstadosContables|ContabilidadTabs/.test(r)], ["6-D · Proveedores, gastos e inmovilizado", (r) => /payables\/|ProveedoresTabs/.test(r)], ["6-F · USALI y cuentas anuales", (r) => /Usali|AnnualAccounts/.test(r)], ["6-B · Tesorería, conciliación, nóminas y comisiones", () => true]],

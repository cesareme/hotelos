...
Estado verificado por tanda (L2, L3, L5, L6a, T8, UX-1 y siguientes): bloques completos en
`docs/audits/ESTADO-VERIFICADO.md` (los integradores añaden allí el suyo; aquí solo este puntero).
...
17. **Tanda CHK · Check-in automatizado (2026-09-19):** (a) índice único

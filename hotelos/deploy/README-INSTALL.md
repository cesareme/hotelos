...
| Usuario inicial | `reception@example.com` / `hotelos-demo` (212 permisos tras el prune de Tanda 4, credencial pública) | Creado por `POST /onboarding/bootstrap`; resto por invitación |

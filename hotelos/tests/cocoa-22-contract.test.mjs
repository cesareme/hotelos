...
const STYLE_BUDGET = {
  ...
  // Cocoa 22 · ola 3 · lote 3-A (Reservas: workspace de detalle 40 · agente de dictado formulario 15; tablero, lista y alta son 25 por defecto; el cronograma `timeline/LiveTimelineWorkspace.tsx` (40) se retiró en la fusión TL 2026-09-19: lo sustituye `timeline/LiveTimeline.tsx`, que nace a 0 y queda en 25 por defecto)
...
/** Rule 13 ceilings (§9) — lowered by every wave to the regenerated inventory (olas 1 · 2 · 4 · 9 integradas el 2026-09-15: 941/647/159/553/539/4607 → 762/488/121/491/419/3795; cierre de tanda A con las correcciones fix:*: inlineStyles 3795 → 3788; Tanda 6 Finanzas integrada el 2026-09-16, lotes 6-A/6-B/6-C/6-D/6-F/8-B/4-B: 762/488/121/491/419/3788 → 589/419/91/409/402/3223; olas 3 · 5 · 7 integradas el 2026-09-16, lotes 3-A/3-B/3-C/5-A/5-B/5-C/7-A/7-B/7-C: 589/419/91/409/402/3223 → 307/203/40/158/70/1833; cierre de la Tanda B con las correcciones fix:* del 2026-09-16: sin cambio, los seis techos igualan los totales regenerados; Tanda 6b · L6/L7 (Estructura societaria y ámbito único) integradas el 2026-09-16: inlineStyles 1833 → 1832, el resto sin cambio; olas 8 · 10 integradas el 2026-09-16, lotes 8-A/8-B/8-C/10-A/10-B/10-C/10-D: 307/203/40/158/70/1832 → 26/12/3/4/2/801 — desde esta tanda el inventario exime los `<input type="file|hidden">` como la regla 4; ola 11 integrada el 2026-09-16, lote 11-A + limpieza (hoja puente, `@layer cocoa-legacy`, componentes sin importador, puente L1c, dev y muertas): 26/12/3/4/2/801 → 0/0/2/0/0/682 — cierre de la migración: las dos `<table>` que quedan son las parrillas de `operations/RoomBlockGridDialog.tsx` y `timeline/LiveTimelineWorkspace.tsx` envueltas en `CocoaScrollArea` con `data-cocoa-grid-table` (excepción de la regla 3), y los 682 `style={` son layout o objetos con nombre con valores del sistema (regla 6)); Tanda 8a · RBAC por departamento integrada el 2026-09-18 (corrector): 682 → 679 — las cuatro pantallas nuevas (Usuarios y roles, cajón de asignación, comparador de plantillas, bandeja de aprobaciones) nacen a 0 y los 3 `style={` que desaparecen eran del UserRoleManager retirado; el resto sin cambio; fusión TL (Live Timeline) integrada el 2026-09-19: rawTables 2 → 1 e inlineStyles 679 → 655 — `timeline/LiveTimelineWorkspace.tsx` (24 `style={` y la segunda `<table>` con `data-cocoa-grid-table`) se retiró y `timeline/LiveTimeline.tsx` + los 15 componentes de `components/timeline` nacen sin `<table` (la parrilla es CSS grid) y con 7 `style={` de geometría ya contados en 679; la única `<table>` que queda es `operations/RoomBlockGridDialog.tsx`; Tanda T8 · Reputación integrada el 2026-09-19: inlineStyles 655 → 647 (ReputationDashboard 6 → 0, GeneralManagerScreen 12 → 10; los cajones nuevos de reputación nacen a 0; files 226 → 232), el resto sin cambio */
const GLOBAL_CEILING = { boCard: 0, rawButtons: 0, rawTables: 1, rawInputs: 0, colourLiterals: 0, inlineStyles: 647 };

...
const RAW_MANUAL_SETUP_OPTIONS: RawManualSetupOption[] = [
  ...
  },
  {
    ...
    apiEndpoint: "/channel-manager/deliveries",
    saveEndpoint: "/channel-manager/deliveries/drain",
    targetTables: ["channel_deliveries", "channel_sync_jobs", "channels", "channel_product_mappings"],

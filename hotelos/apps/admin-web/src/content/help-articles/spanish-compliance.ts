...
## Como funciona el envio en ${BRAND.name}
...
${BRAND.name} automatiza estos flujos desde Compliance > Solicitudes RGPD. El plazo de respuesta es de **1 mes** prorrogable a 3.

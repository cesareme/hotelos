...
describe("BACKOFFICE_ROUTES · one URL per screen of the tree", () => {
  it("registers the 193 URLs of the tree in tree order, the base URL of every container before its tabs", () => {
    // Tanda 5: 167 · Tanda 6 (Finanzas: Contabilidad, Proveedores y gastos, estados, 347/libros/liquidación, Cierre de caja): 183 · Tanda 6b (Estructura societaria + 4 pestañas): 188 · Tanda 7 (Reservas › Importar): 189 · Tanda 7b (Modo sombra OPERA): 190 · Tanda 7c (Contabilidad › Importar desde Sage 200): 191 · Tanda 8a (Hoy › Pendientes de aprobación): 192 · Tanda CHK (Hoy › Mi día › Check-in automatizado): 193.
    assert.equal(BACKOFFICE_ROUTES.length, 193);

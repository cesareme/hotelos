...
export const AI_ONBOARDING_AGENTS: AiOnboardingAgentDefinition[] = [
  ...
  { name: "RatePlanMapperAgent", responsibility: "Maps source rate plans to ehotelOS rates, restrictions and derivations.", canApplyMigration: false, requiresHumanReview: true, writesDatabaseDirectly: false },

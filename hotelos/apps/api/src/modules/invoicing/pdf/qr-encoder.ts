// Minimal QR Code encoder (ISO/IEC 18004, byte mode, versions 1-20) for the
// VeriFactu QR printed on invoices. Pure, dependency-free: no QR library is
// declared in this workspace (the only one present, qrcode-terminal, is a
// transitive dependency of the Expo CLI and renders to a terminal). The
// unit test cross-checks every module of this encoder against that
// reference implementation (Kazuhiko Arase's qrcode-generator) for the same
// version, error-correction level and mask.
//
// VeriFactu (Orden HAC/1177/2024 art. 21): error-correction level M, printed
// between 30 and 40 mm; the URL is ~130 characters, which fits version 7-8.

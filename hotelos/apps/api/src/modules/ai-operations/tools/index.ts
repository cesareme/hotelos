...
// lecturas/borradores (effect "read", ejecución inmediata por el runner) y 13
...
// Tanda T9 (lote T9-06a): +1 escritura proposeIncomingDocumentAction (propuesta de
// acción sobre un documento digitalizado).
...
const IMPLEMENTATIONS: AnyAiToolImpl[] = [
  ...
  // Escrituras (13): siempre awaiting_confirmation
  assignRoomTool,

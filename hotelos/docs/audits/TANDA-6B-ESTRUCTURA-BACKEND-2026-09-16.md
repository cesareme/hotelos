...
| 11 | **Series de Rías Altas**: cerrar `FAC-2026-` / `REC-2026-` (sandbox con tres NIF de prueba) y abrir `FAC-RA-2026-`, `FS-RA-2026-`, `R-RA-2026-`; Los Tilos ya usa `-LT-`. Ninguna factura se renumera ni se reescribe | Paso 6 de la migración; la clave `(propertyId, sequenceCode, year)` obliga a liberar la fila sandbox (`active = false`, `sequence_code = FAC-SANDBOX`) antes de abrir la nueva | Confirmación |

...
- «Reportar incidencia» (Pisos › Mi turno, «Reportar»): subtítulo «Habitación <n.º>», campo «Incidencia» («Describe la incidencia»; «Avería, falta de amenities, desperfectos… Se crea una orden de trabajo para mantenimiento.»), botón «Enviar a mantenimiento».

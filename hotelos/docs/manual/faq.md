...
Cómo se ha hecho: todos los mensajes se han comprobado en la versión de ehotelOS del 19 de septiembre de 2026, en la aplicación de demostración («Hotel Demo Madrid Centro», datos ficticios) o en el propio código de la aplicación cuando provocarlos habría bloqueado la cuenta o alterado datos (por ejemplo, el bloqueo por intentos de acceso fallidos); las entradas de este segundo grupo lo indican. Las respuestas de recepción («Reservas y huéspedes»: Mi día, check-in, check-out, walk-in, nueva reserva, ficha, lista y Live Timeline) se revisaron tras la tanda UX-1 recorriendo cada pantalla en los dos hoteles de prueba sin pulsar ninguna acción que escriba: los textos de cajones y diálogos se citan tal como aparecen antes de confirmar, y el resultado de confirmar se toma de las pruebas automáticas de esa tanda.
...
Las respuestas de este bloque se han recorrido en la aplicación el 19 de septiembre de 2026, tras la tanda UX-1, en los dos hoteles de prueba con datos ficticios («Hotel UXDAY (prueba)» y «Hotel Demo Madrid Centro») sin pulsar ninguna acción que escriba: los textos de los cajones y diálogos se citan tal como aparecen antes de confirmar, y los mensajes del servidor, del código de ehotelOS. El detalle paso a paso está en la [guía de recepción](70-recepcion.md).

**P:** En «Nueva reserva» el botón «Crear reserva» no se activa, o al pulsarlo sale «No se pudo crear la reserva.» (y en la vista «Completa», «Consultar disponibilidad» o «Siguiente» no me dejan seguir).

**R:** En la vista «Rápida» (la que se abre por defecto) el botón se queda desactivado hasta que el formulario está completo y el motivo aparece bajo el campo que falla; en la vista «Completa», «Siguiente» no avanza por la misma razón. Por este orden:
1. **La salida no es posterior a la llegada.** Bajo «Salida» sale «La salida debe ser posterior a la llegada.» y en la vista «Completa» «Siguiente» no avanza (el mismo aviso, como «La fecha de salida debe ser posterior a la fecha de llegada.», aparece en la ficha de la reserva al cambiar «Fechas de la estancia»). Corrige la fecha o pulsa «+1 noche».
2. **La llegada está en el pasado.** «La llegada es anterior a hoy.»: desde recepción no se crean llegadas pasadas, casi siempre es una fecha mal tecleada. Si se fuerza, el servidor la rechaza («La llegada 2026-09-18 es anterior a hoy (2026-09-19): comprueba las fechas…») y exige el permiso de modificar reservas. Escribe «hoy» o «mañana» en el campo «Llegada».
3. **Falta el tipo o el huésped.** «Elige un tipo de habitación.» o «Indica nombre y apellido del huésped.» (nombre y apellido son lo único obligatorio del huésped).
4. **No hay precio.** Con «Plan de tarifas» en «Sin plan tarifario (tarifa BAR del hotel)» el precio sale de la parrilla («Cotizado: 89,00 €», «Total 89,00 € · tarifa publicada»). Si alguna noche no tiene BAR verás «Sin tarifa publicada para esas noches: indica el importe total.» o «Precio de relleno: alguna noche no tiene tarifa publicada. Indica el importe total para poder crear la reserva.»: escribe «Precio total (€)» a mano o pide a revenue que cargue la tarifa. «Sin disponibilidad para esas fechas y ocupación.»: cambia el tipo de habitación o las fechas.
5. **«No se pudo crear la reserva.»** sin motivo debajo (o, en la vista «Completa», «No se pudo consultar la disponibilidad.» con «Reintentar»): fallo momentáneo de red o sesión caducada. Reintenta una vez; si te ha devuelto a «Inicia sesión», entra de nuevo y crea la reserva otra vez (el formulario no se guarda).

Comprobado en el Hotel UXDAY cambiando las fechas del formulario, sin crear nada; los textos del servidor, en el código. Guía: [Recepción › Nueva reserva](70-recepcion.md#nueva-reserva) · [Comercial y revenue › 1. Tarifas y parrilla](50-comercial-revenue.md#1-tarifas-y-parrilla).

**P:** En el cajón «Check-in» el botón de abajo está desactivado (la habitación está «Sucia», o el pie dice «Asigna una habitación primero.»), o al confirmar sale «Indica el motivo del check-in fuera de ventana.» o «Sin habitación válida para el check-in.».

**R:** El pie del cajón dice siempre por qué el botón no se activa:
- **«La habitación no está lista. Cambia de habitación o marca «Hacer check-in igualmente» con un motivo.»** La habitación asignada está «Sucia» (en el hotel de prueba, la 110 de UXDAY-A3). Lo normal es pulsar el botón de la sugerencia («Sugerencia · La 101 está limpia, libre y es del mismo tipo.» → «Cambiar a la 101») o elegir otra limpia en el desplegable «Cambiar habitación». La excepción: activar el interruptor «Hacer check-in igualmente (la limpieza sigue siendo de pisos; el motivo queda auditado)» y escribir el motivo; la limpieza de la habitación sigue en la lista de pisos.
- **«Asigna una habitación primero.»** La reserva no tiene habitación (o has elegido «Sin asignar» en el desplegable). En Mi día no hace falta llegar ahí: la fila dice «sin asignar → 101» y su botón «Check-in en 101» abre el cajón con la 101 ya elegida (la primera limpia y libre del tipo). En el panel del Live Timeline, en cambio, «Check-in» está desactivado hasta que pulsas «Asignar habitación».
- **«Indica el motivo del check-in fuera de ventana.»** Un check-in fuera de la ventana del hotel (la fecha de negocio y un día de margen) es una excepción auditada: exige el permiso de modificar reservas y un motivo. En Mi día, la fila de una reserva cuya llegada queda fuera de esa ventana no ofrece «Hacer check-in»; si el servidor lo rechaza igualmente, el cajón lo dice en lenguaje de mostrador: «La reserva llega el <fecha>: el check-in solo se admite con un día de margen. Si el huésped ya está aquí, adelanta la llegada desde la ficha.».
- **«Sin habitación válida para el check-in.»** No sale del cajón: lo devuelve la importación de reservas cuando una fila llega como ya alojada sin una habitación válida. La reserva se queda «Confirmada» y la alojas después desde Mi día.

Comprobado en el Hotel UXDAY con la llegada UXDAY-A3 (habitación 110 sucia) y con la llegada sin habitación («Check-in en 101», luego «Sin asignar»); los mensajes del servidor, en el código. Guía: [Recepción › Llegadas y check-in](70-recepcion.md#llegadas-y-check-in) · [Check-in cuando la habitación no está lista](70-recepcion.md#check-in-cuando-la-habitación-no-está-lista-sucia).

**P:** La cola «Lo siguiente que hay que hacer» de Mi día se llena de tarjetas «Posible no-show · <nombre>», una por cada llegada pendiente. ¿Es un error?

**R:** No. A partir de las 19:00, ehotelOS crea una tarjeta «Urgente · Riesgo no-show» por cada llegada prevista hoy que sigue «Confirmada» sin check-in, con el texto «Llegada prevista hoy. Ya pasan de las 19:00 y no ha hecho check-in.» y los botones «Contactar huésped», «Hacer check-in» y «Marcar no-show». Por la mañana no las verás. Trátalas una a una: si el huésped llega, «Hacer check-in»; si ha avisado de que llega tarde, déjala; si no se presenta, «Marcar no-show» (abre el diálogo con motivo y penalización prevista, igual que el de cancelar; ver la pregunta de la reserva duplicada). La cola se recalcula sola cada 30 segundos y con «Actualizar». Las tarjetas «Late checkout sin resolver · Hab. <n.º>» («<nombre> debería haber salido. Es tarde y sigue alojado.», botón «Hacer check-out») son lo mismo para las salidas que no han hecho check-out.

Comprobado en el hotel de demostración (tres tarjetas a las 23:00) y en el Hotel UXDAY. Guía: [Recepción › Mi día](70-recepcion.md#mi-día).

**P:** En «Salen hoy» una fila dice «Cobrar 120,00 € y cerrar» en vez de «Hacer check-out», y al marcar varias filas el lote solo cierra algunas («3 filas seleccionadas» pero el botón dice «Check-out de 2 con saldo 0»).

**R:** El botón de cada fila dice lo que va a hacer: con saldo pendiente, «Cobrar <importe> y cerrar»; con saldo 0, «Hacer check-out». Los dos abren el cajón «Check-out»:
1. **«1 · Folio»**: revisa las «Líneas del folio» y los «Totales del folio» («Total cargos», «Pagos previos», «Saldo»).
2. **«2 · Cobro»**: «Importe a cobrar: 120,00 €» y el «Método» («Tarjeta (datáfono)», «Efectivo», «Transferencia»; con tarjeta ehotelOS anota el cobro, no habla con el datáfono). Si el hotel admite que el huésped salga debiendo, activa «Sin cobro ahora (el huésped saldrá con saldo pendiente)»: el folio queda abierto para Facturación.
3. **«3 · Salida y factura»**: por defecto «Borrador para Facturación» («Queda como borrador con los cargos del folio; Facturación la emite.»); «Emitir ahora con número» la emite al cerrar, es irreversible y entra en la cadena VeriFactu del hotel; «Sin factura» solo vale si el folio no tiene cargos sin facturar (si los tiene, el cierre se rechaza con «El folio tiene n cargos por X € sin facturar: emite la factura … antes de cerrarlo.»). En «Factura a», «Huésped» (simplificada) o «Empresa» (razón social y NIF).
4. Pulsa «Cobrar 120,00 € y cerrar» (o Intro). Si el servidor encuentra un saldo que el cajón no tenía, verás el aviso «Saldo pendiente detectado» con tres botones: «Cobrar <importe> y cerrar», «Salir con saldo pendiente» y «Cancelar».

El lote «Check-out de n con saldo 0» solo admite estancias «En el hotel» que salen hoy y con saldo 0, porque el check-out no se puede deshacer y una salida con saldo necesita que decidas su cobro y su factura. Por eso, con tres filas marcadas de las que una tiene saldo, la barra «Acciones sobre la selección» dice «3 filas seleccionadas», el botón «Check-out de 2 con saldo 0» y «Imprimir 3 fichas» (esta sí cuenta las tres); la fila con saldo se cierra sola con «Cobrar … y cerrar». El diálogo del lote lo avisa: «Se cerrarán 2 estancias con saldo 0 que salen hoy (la 206, la 207). Las habitaciones pasarán a sucia y el check-out no se puede deshacer.».

Comprobado en el Hotel UXDAY (habitación 204 con 120,00 € pendientes; lote con la 206, la 207 y la 204 marcadas); ningún check-out ejecutado. Guía: [Recepción › Salidas y check-out](70-recepcion.md#salidas-y-check-out) · [Check-out en lote](70-recepcion.md#check-out-en-lote-salidas-con-saldo-0) · [Administración › 5. Facturación y VeriFactu](20-administracion.md#5-facturación-y-verifactu).

**P:** He hecho un walk-in con cobro y en el folio no aparece el cargo de alojamiento: solo el cobro, y el saldo sale a favor del huésped.

**R:** Es el comportamiento actual, no un cobro perdido. El cajón «Walk-in» lo avisa en «Cobro»: «El cobro se registra al hacer el check-in, como anticipo del importe de la estancia.». El cargo de alojamiento lo asienta el cierre del día en los folios de las estancias «En el hotel», así que hasta entonces el folio del walk-in muestra el cobro como anticipo (saldo negativo). No vuelvas a cobrar: al ejecutarse el cierre, el cargo compensa el anticipo. Si creaste el walk-in con «Sin cobro», el cajón dice «Sin cobro ahora: el saldo se cobra desde la ficha o al hacer el check-out.»: cóbralo desde la ficha («Más ▾» › «Cobrar…») o en el check-out.

Comprobado el texto del cajón en el Hotel UXDAY (sin crear el walk-in); el resultado, en las pruebas automáticas de la tanda UX-1. Guía: [Recepción › Walk-in](70-recepcion.md#walk-in) · [Qué no hace todavía](70-recepcion.md#qué-no-hace-todavía).

**P:** Me he equivocado de habitación (o he hecho el check-in en la que no era). ¿Puedo deshacerlo?

**R:** Depende de lo que hayas hecho:
- **Cambio de habitación** desde la ficha («Cambiar habitación» › «Mover a la 311»), desde el panel del Live Timeline («Cambiar habitación» / «Asignar habitación») o arrastrando la barra en la parrilla: se aplica al momento y durante 8 segundos ves un aviso con «Deshacer» (también ⌘Z mientras dura). Si el huésped ya estaba «En el hotel», deshacer es un traslado nuevo: la habitación intermedia queda «Sucia» con su tarea de limpieza. Pasados los 8 segundos, vuelve a «Cambiar habitación» y elige la buena.
- **Primera asignación** de una reserva sin habitación desde la cola de Mi día: no tiene «Deshacer» (no hay habitación anterior a la que volver). Cámbiala con «Cambiar habitación».
- **Check-in en la habitación equivocada**: el check-in no se deshace. Cambia de habitación desde la ficha (con el huésped «En el hotel», la ficha solo admite ese cambio) y avisa a pisos: la que has dejado pasa a «Sucia» con su tarea de limpieza.
- **Check-out, cancelación y no-show**: irreversibles por diseño; no tienen «Deshacer».

Los pasos y textos se han comprobado en el Hotel UXDAY hasta el botón «Mover a la 311» sin pulsarlo; el «Deshacer» viene de las pruebas automáticas de la tanda UX-1. Guía: [Recepción › Cambiar de habitación](70-recepcion.md#cambiar-de-habitación-con-deshacer) · [Qué no hace todavía](70-recepcion.md#qué-no-hace-todavía).

**P:** En «Reservas» escribo el número de habitación («310») y el contador dice «0 de 0» con «Ninguna reserva de esta vista está en la 310», aunque la habitación está ocupada.

**R:** La búsqueda filtra **dentro de la vista** que tienes abierta (por defecto «Llegan hoy»), y la propia pantalla lo explica bajo el aviso: «La habitación se busca sobre las reservas cargadas de la vista; «En el hotel» tiene todas las ocupadas.». Pulsa la vista «En el hotel» (o «Todas») y verás «1 de 1» con la reserva («UXDAY-T4 · Raúl Lambda · 310 · … · En el hotel» en el hotel de prueba); haz clic en una celda de la fila (o Intro) para abrir su panel «Detalle de la reserva UXDAY-T4». Por nombre o código pasa lo mismo: la búsqueda va al servidor, pero siempre dentro de la vista elegida, así que cambia de vista antes de buscar. Con ⌥F el cursor se pone en el buscador.

Comprobado en el Hotel UXDAY. Guía: [Recepción › Buscar por número de habitación](70-recepcion.md#buscar-por-número-de-habitación).

**P:** En el Live Timeline he arrastrado una barra y se ha movido sin preguntarme; otras veces no se mueve y sale «Una reserva en casa solo puede cambiar de habitación», «La habitación está ocupada actualmente», «La habitación está bloqueada por mantenimiento o no es vendible» o «La reserva está cerrada».

**R:** Las dos cosas son normales. Mover o redimensionar una estancia (arrastrando, o con ⌥ y las flechas sobre la barra seleccionada) se aplica al momento, sin diálogo, y durante 8 segundos ves el aviso con «Deshacer» (⌘Z mientras dura); solo el check-in, el check-out, cancelar y el no-show piden confirmación. Lo que no se puede hacer, la pantalla lo rechaza al soltar (o al pulsar la tecla) con un aviso y sin cambiar nada:
- **«Una reserva en casa solo puede cambiar de habitación»**: una reserva «En el hotel» («en casa» es el vocabulario antiguo, que este texto y la ficha rápida conservan) no cambia de fechas desde aquí, solo de habitación (hacia arriba o abajo, o con ⌥↑ / ⌥↓). Hoy tampoco la ficha permite cambiar la salida de un huésped «En el hotel»: ver [Qué no hace todavía](70-recepcion.md#qué-no-hace-todavía).
- **«La reserva está cerrada»**: las salidas hechas, las canceladas y los no-show no se mueven.
- **«La habitación está ocupada actualmente»** y **«La habitación está bloqueada por mantenimiento o no es vendible»**: no puedes soltar sobre una habitación ocupada por otra reserva, bloqueada o fuera de servicio (carril rayado, etiqueta «BLOQUEADA»). Elige otra fila.
- **«La habitación entra en conflicto con otra reserva en esas fechas»** o **«La reserva cambió mientras se procesaba: actualiza y repite»**: el servidor ha rechazado el cambio (otra reserva ocupaba esa habitación fuera de las fechas que tenías cargadas, o alguien tocó la misma reserva a la vez). Pulsa «Actualizar» y repite.

Para cancelar un arrastre antes de soltar, pulsa Esc: la barra vuelve a su sitio. El Live Timeline no recalcula el precio al mover fechas: revísalo en la ficha de la reserva.

Comprobado en el hotel de demostración pulsando ⌥→ sobre la reserva RES-18399 («En el hotel»): aparece el aviso y no se envía ningún cambio; el resto de textos, en el código de la pantalla. Guía: [Recepción › Live Timeline](70-recepcion.md#live-timeline) · [Errores frecuentes en el Live Timeline](70-recepcion.md#errores-frecuentes-en-el-live-timeline).
...
**R:** Los tres primeros, por orden: los filtros o la búsqueda no dejan pasar ninguna reserva (pulsa «Limpiar filtros»); no hay reservas en las fechas elegidas («Hoy» o cambia el periodo); o la propiedad no tiene habitaciones cargadas ni reservas (en un hotel nuevo faltan las habitaciones: las da de alta dirección en «Configuración › Habitaciones y espacios», una pantalla que las plantillas de dirección sí ven y «Administración de sistema» no; ver [Dirección › 10](10-direccion.md#10-configurar-el-hotel-propiedad-habitaciones-facturación-y-ajustes)). Las canceladas solo se dibujan si enciendes el chip «Cancelada» (el único apagado por defecto), y una cancelada sin habitación no se dibuja nunca: búscala en «Recepción › Reservas», vista «Canceladas».
...
**P:** Tengo una reserva duplicada (mismo huésped, mismas fechas). ¿Cómo la cancelo sin cargar la penalización al huésped?
...
1. Abre las dos desde «Menú › Recepción › Reservas» (busca por nombre en la vista «Todas») y compara «Origen» y la política de cancelación. Conserva la que tenga la garantía de pago o, si el huésped ya ha hecho el check-in, la que está «En el hotel».
2. En la ficha de la duplicada (tiene que estar «Confirmada») pulsa «Más ▾» › «Cancelar reserva…». El diálogo «¿Cancelar la reserva <código>?» explica que «La reserva dejará de contar en la ocupación. La penalización prevista por su política se carga al folio como línea no sujeta a IVA y, si el saldo queda a cero, el folio se cierra.», muestra la política («Política «Flexible 24 h» · Penalización prevista de 89,00 € … Plazo gratuito hasta 19 sept 2026, 14:00.») y trae el campo «Motivo» (obligatorio: «Queda en la auditoría de la reserva. Intro confirma.») y el interruptor «Aplicar la penalización prevista», activado.
3. Escribe el motivo («Duplicada de <código>») y **desactiva** «Aplicar la penalización prevista»: el botón pasa de «Cancelar la reserva (penalización 89,00 €)» a «Cancelar la reserva (sin penalización)». Púlsalo (o Intro). Si renunciar a la penalización supera tu tramo, el diálogo pide «Autorizar con PIN de supervisor»: que lo escriba quien lo tenga.
4. Si la duplicada entró por una agencia, cancélala también en su extranet para que no genere comisión.

La cancelación no tiene «Deshacer». Una reserva «En el hotel» no se cancela (el servidor responde «La reserva … no se puede pasar a cancelled estando checked_in.», con los estados en inglés): se cierra con el check-out. «Marcar no-show…» funciona igual («¿Marcar <código> como no-show?», motivo sugerido «No se ha presentado ni ha avisado», botón «Marcar no-show (penalización 89,00 €)»).

Comprobado en el Hotel UXDAY (reserva UXDAY-T1) hasta el botón de confirmar, sin pulsarlo. Guía: [Recepción › Cancelar o marcar no-show](70-recepcion.md#cancelar-o-marcar-no-show).

**P:** Los atajos con ⌥ (⌥H, ⌥W, ⌥N, la letra que aparece junto a cada botón) no me funcionan.

**R:** Tres causas, por orden:
1. **Estás escribiendo en un campo de texto.** Mientras el cursor está en un buscador o en un campo de un formulario, ⌥ + letra no actúa (comprobado en Mi día: con el cursor en «Buscar por nombre o habitación (⌥F)», ⌥W no abre el walk-in). Pulsa Esc o Tab para salir del campo y repite. Con el foco en una casilla de selección de la tabla sí actúa (comprobado: ⌥W abre el walk-in y ⌥O abre la ficha).
2. **Windows o Linux.** ⌥ es **Alt** y ⌘ es **Ctrl**: Alt+W, Alt+N, Ctrl+K. Mantén Alt pulsada mientras pulsas la letra (Alt suelto abre el menú de algunos navegadores).
3. **Ese botón no tiene tecla de acceso.** Mantén ⌥ pulsada: solo los botones que muestran una letra al lado responden (en el panel de Mi día, C = «Hacer check-in» y O = «Abrir ficha completa»; en la ficha, C = la acción principal (si la hay), M = «Asignar habitación» / «Cambiar habitación» y P = «Cobrar…» cuando aparece como botón, y «Más ▾» no tiene letra; en Nueva reserva, D depósito · I check-in · C crear; en los cobros, ⌥1 efectivo · ⌥2 tarjeta · ⌥3 transferencia). La hoja «Atajos de teclado» (⌘/, también desde el Centro de ayuda «?») los lista todos.

Comprobado en el Hotel UXDAY. Guía: [Recepción › Atajos de teclado](70-recepcion.md#atajos-de-teclado) · [Primeros pasos › 10. Atajos de teclado](00-primeros-pasos.md#10-atajos-de-teclado).
...
**R:** La importación por pantalla («Menú › Recepción › Reservas › Importar», `/recepcion/reservas/importar`, pasos «1. Fichero · 2. Columnas · 3. Revisión · 4. Resultado») está pensada para ficheros pequeños: como mucho 5 MB y 5.000 filas. Parte el fichero por meses, guárdalo como `.xlsx` normal o como CSV y usa «Descargar plantilla CSV» o «Descargar plantilla XLSX» para copiar las cabeceras. Si todas las filas salen omitidas o con errores, el paso «3. Revisión» te dice qué columna falla en cada una. La pantalla avisa de lo que necesitas: «Necesitas los permisos de crear y modificar reservas para importar un lote; deshacer uno exige el de modificar: puedes previsualizar el fichero y consultar las importaciones anteriores.». Las cargas grandes (migraciones) las hace administración de sistema por línea de comandos. (Pantalla comprobada en el Hotel UXDAY; textos de error comprobados en el código).

Guía: [Recepción › Qué verás en tu menú](70-recepcion.md#qué-verás-en-tu-menú) · [Sistemas › 5.2 Modo sombra OPERA](60-sistemas.md#52-modo-sombra-opera).

**P:** He registrado un cargo o un cobro y el folio no cambia.

**R:** Casi siempre es la pantalla sin refrescar, o el movimiento se hizo en otro folio de la misma reserva (tras dividirlo). Pulsa «Actualizar» en el folio o vuelve a abrirlo desde «Finanzas › Facturación y cobros»; revisa los demás folios en la pestaña «Folio (n)» de la ficha de la reserva. Si acabas de añadir el cargo desde la ficha, recuerda que durante 8 segundos el aviso «Deshacer» permite retirarlo antes de que llegue al servidor. Si acaba de ejecutarse el cierre del día, espera a que termine. Si sigue sin aparecer, pide a dirección que compruebe tu plantilla en «Usuarios y roles» (hay categorías de cargo que no todas ven).

Guía: [Recepción › Ficha de reserva](70-recepcion.md#ficha-de-reserva) · [Administración › 5.1 El centro de facturación](20-administracion.md#51-el-centro-de-facturación).

## Pisos y mantenimiento

**P:** Pulso «Nueva tarea», «Reportar», «+ Nueva orden» o «Nota»: ¿qué se abre? ¿Y si no veo nada?

**R:** Cada uno abre un formulario lateral (un «cajón») que se cierra con «Cancelar», la × o Esc sin guardar nada:
- «Nueva tarea» (Pisos › Tablero, tarjeta de la habitación): subtítulo «Habitación 304», desplegables «Tipo de tarea» y «Prioridad», botón «Crear tarea».
- «Reportar incidencia» (Pisos › Mi turno, «Reportar»): subtítulo «Habitación <n.º>», botones de motivo («Fuga de agua», «Bombilla», «Aire acondicionado», «TV/Wi-Fi», «Cerradura», «Otro»), botón «Foto» (hasta 3, cámara trasera en la tablet) y «Detalle» opcional, botón «Enviar a mantenimiento» (aviso «Avería de la <n.º> enviada a mantenimiento · 1 foto»).
- «Nueva orden de trabajo» (Mantenimiento › Tablero, «+ Nueva orden»): «Se crea abierta; asígnala o bloquea la habitación desde su ficha.», campos «Título», «Habitación», «Prioridad», «Descripción» y el interruptor «Bloquea la habitación (fuera de servicio)», botón «Crear orden».
- «Añadir nota» (Mantenimiento › Mis averías, «Nota»): campo «Nota» («Qué has visto o qué has hecho»), botón «Guardar nota».

Los cuatro se abren y se ven en la versión del 19 de septiembre de 2026 (comprobados en el hotel de demostración con «Ver como…» Pisos y Mantenimiento; también los de «Registrar incidente», «Nuevo contrato», «Nuevo asiento», «Invitar con ámbito» y el resto de formularios laterales del manual). Si al pulsar no aparece nada: pulsa Esc, después «Actualizar» y, si sigue igual, recarga la página (F5) y comprueba que sigues dentro; si persiste, anota la pantalla y la hora y avisa a administración de sistema. Lo que no pasa por un cajón («Marcar limpia», «Empezar», «Completar», «Tomar», «Resuelta») actúa directamente desde el tablero; «Marcar limpia», «Inspeccionar», «Limpia», «Inspeccionada», «Tomar», «Resuelta» y «Resolver» ofrecen «Deshacer» durante 8 segundos en el aviso.

Guía: [Pisos y mantenimiento › Tarea 2](40-pisos-mantenimiento.md#tarea-2--crear-una-tarea-para-una-habitación) · [Tarea 5](40-pisos-mantenimiento.md#tarea-5--reportar-una-avería-desde-una-habitación-enlace-con-mantenimiento) · [Tarea 9](40-pisos-mantenimiento.md#tarea-9--crear-un-parte-tomarlo-anotar-bloquear-la-habitación-y-resolverlo) · [Tarea 10](40-pisos-mantenimiento.md#tarea-10--mis-averías-móvil-y-tablet).
...
Si además ves «FUERA DE SERVICIO» o «Bloqueada», hay un parte abierto: ver la pregunta siguiente. En «Mi turno», «Limpia» cierra también la tarea de limpieza (aviso «Hab. <n.º> → Limpia · tarea cerrada»); si inspeccionas sin haber pulsado «Limpia», la tarea sigue abierta: pulsa «Limpia» en la tarjeta o «Completar» en el tablero. Cada aviso verde ofrece «Deshacer» durante 8 segundos; pulsado más tarde, el aviso dice «Habitación <n.º> ya enviada: no se puede deshacer.» (el cambio ya está guardado).
...
- **Recepción: sin «Deshacer» del check-in** ni de la primera asignación de habitación desde la cola de Mi día (no hay habitación anterior a la que volver); el check-out, cancelar y el no-show son irreversibles por diseño. Sí tienen «Deshacer» (8 segundos, ⌘Z) el cambio de habitación, los movimientos del Live Timeline y el cargo añadido desde la ficha.
- **Folio del walk-in sin el cargo de alojamiento** hasta que se ejecuta el cierre del día: hasta entonces el cobro figura como «anticipo» (saldo a favor del huésped).
- **Fechas de una reserva «En el hotel» bloqueadas.** Ni la ficha («Con el huésped alojado el API solo admite el cambio de habitación (REC-03).») ni el Live Timeline («Una reserva en casa solo puede cambiar de habitación») permiten cambiar la salida de un huésped alojado: hoy solo se cambia de habitación.
- **Factura al check-out.** Por defecto queda como «Borrador para Facturación»; «Emitir ahora con número» entra en la cadena VeriFactu del hotel (en los hoteles de prueba, en modo de pruebas).
- **Lista de reservas.** El menú «Columnas» no limita su alto ni cambia de lado en pantallas pequeñas. ⌥ + letra no actúa con el cursor en un campo de texto (sal de él con Tab o Esc); con una casilla de selección enfocada sí actúa (comprobado el 19/09/2026 con ⌥W y ⌥O).
- **⌘K sin «Tarea siguiente» ni «Exportar sesión de prueba»** (existen solo como ⌘⇧T / ⌘⇧E con el modo prueba activo).

...
> **Nota:** en la versión de ehotelOS del 19/09/2026 los **cajones laterales** (paneles que se abren por el lado derecho) **no se muestran en pantalla**: el botón responde, pero el panel queda oculto por un defecto conocido de la interfaz, pendiente del proveedor. Afecta a «Nuevo asiento», «Nueva cuenta», «Nuevo proveedor», «Nueva factura recibida», «Nueva cuenta bancaria», «Nueva rectificativa», al detalle del borrador y de la factura («Ver detalle», con «Emitir factura», «Rectificar» y «Anular») y a la ficha de la factura recibida (la de «Aprobar»). **No** afecta a las ventanas centradas, que se ven y funcionan: «Registrar pago» / «Cobrar», «Devolver», «Crear ejercicio» y las confirmaciones. Las capturas de los cajones (los pasos de creación de este documento) se han tomado con una corrección temporal aplicada solo en el navegador de captura; «registrar-pago.png» es una ventana normal y no la necesitó. Hasta que se publique la corrección, los pasos que pasan por un cajón no se pueden completar desde la pantalla; el resto de la guía (consultas, filtros, descargas, cobros, el asistente de Sage 200) funciona tal como se describe.
...
> **En construcción:** la ficha que abre «Ver detalle» (borrador y factura emitida) es un cajón lateral y hoy **no se ve en pantalla** (defecto descrito en «Cómo están hechas las capturas»): la lista de borradores y el botón funcionan, pero la ficha no se muestra y, por tanto, «Emitir factura», «Rectificar», «Anular», «Enviar por correo» y «Descargar PDF» no se pueden pulsar desde ella hasta la corrección. Lo que sigue en 5.4 describe la ficha según su diseño y la guía de referencia; el PDF de una factura ya emitida se descarga también desde «Rectificativas» («Descargar PDF» en cada fila).
...
4. Se abre la ficha «Factura MANUAL-ADM-001 · MANUAL-ADM Lavandería Demo SL · Borrador» con «BASE 100,00 € · IVA 21,00 € · RETENCIÓN 0,00 € · TOTAL 121,00 €», las líneas y los botones «Anular», «Cerrar» y «Aprobar». En tu hotel el circuito sigue con «Aprobar» y «Contabilizar» (asiento D 6xx / D 472 / H 400 o 410) y «Registrar pago» al pagarla (D 400 / H 572); en la demo la dejamos en «BORRADOR».
   ...
   > **En construcción:** esta ficha (la que se abre al guardar o al pulsar una fila de «Facturas recibidas») es un cajón lateral y hoy **no se ve en pantalla**: la factura se guarda, pero «Aprobar», «Contabilizar» y «Anular» no se pueden pulsar desde la pantalla hasta que se corrija el defecto de los cajones. La captura se hizo con la corrección temporal de captura.
...
- **Cajones laterales ocultos (19/09/2026):** los formularios de alta que se abren por el lado derecho («Nuevo asiento», «Nueva cuenta», «Nuevo proveedor», «Nueva factura recibida», «Nueva cuenta bancaria», «Nueva rectificativa»), la ficha del borrador y de la factura («Ver detalle» › «Emitir factura», «Rectificar», «Anular») y la ficha de la factura recibida («Aprobar») no se muestran hasta que el proveedor corrija el defecto indicado en «Cómo están hechas las capturas». Sí funcionan las ventanas centradas («Cobrar», «Devolver», «Crear ejercicio»), las consultas, las descargas y el asistente de Sage 200.
...
- [70 · Recepción](70-recepcion.md) — check-in, partes de viajeros desde recepción y cobros en el folio (se completa en DOC-2).

...
4. Para tomarla, elige «En curso» en el desplegable «Estado» («Abierta», «Asignada», «En curso», «Esperando proveedor»; «El cambio se guarda al elegirlo.»). Aviso «Estado actualizado.». Desde el móvil, en la pestaña «Mis averías» (`/operaciones/mantenimiento/mis-averias`) es el botón «Tomar».

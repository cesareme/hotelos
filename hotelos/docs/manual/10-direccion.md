...
> **En construcción:** el detalle lateral de la propuesta (el que abre «Rechazar» o el clic en la fila) es un cajón que hoy **no se muestra en pantalla** por el defecto conocido de los cajones laterales de la aplicación: el botón responde, pero el panel con «Motivo del rechazo» queda oculto (ciérralo con Esc). Hasta que el proveedor lo corrija, no se puede rechazar una propuesta desde la pantalla; «Asignar», «Aprobar» y «Escalar» sí funcionan. Ten en cuenta que «Asignar» no pide confirmación: no lo pulses por probar.
...
> **En construcción:** el cajón «Invitar con ámbito» (y la ficha que se abre al pulsar la fila de una persona) hoy **no se muestra en pantalla** por el defecto conocido de los cajones laterales: el botón responde, pero el formulario queda oculto (ciérralo con Esc). Hasta que el proveedor lo corrija, las altas no se pueden completar desde esta pantalla. Además, «Comparar plantillas» falla con «Algo ha fallado en la interfaz · El error ya ha sido reportado al equipo. Puedes intentarlo de nuevo.» y el botón «Reintentar»: usa la tabla de plantillas de [60-sistemas.md](60-sistemas.md) y pide al proveedor la tabla de accesos por departamento. El interruptor «Exigir doble factor (2FA)» deja hoy solo la marca «2FA: Activo» en la ficha; la verificación del segundo factor al entrar no está activada todavía.
...
- **Cajones laterales ocultos (19/09/2026).** Los paneles que se abren por el lado derecho no se muestran en pantalla por un defecto conocido de la interfaz, pendiente del proveedor: en esta guía afecta al detalle de una propuesta en Pendientes de la IA (el que abre «Rechazar», con «Motivo del rechazo»; tarea 5) y al cajón «Invitar con ámbito» y la ficha de cada persona en Usuarios y roles (tarea 9). Las ventanas centradas (confirmaciones, «Cerrar de todos modos») sí se ven.

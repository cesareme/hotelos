...
- Tema claro (botón «Claro» de la barra superior), ventana de 1280 × 800 píxeles, idioma español. La tarjeta de instrucciones del Live Timeline y el aviso de puesta en marcha («Falta 1 comprobación para poner la propiedad en marcha.») están ocultos en las capturas; en tu hotel puedes cerrarlos con «Cerrar instrucciones» (×) y «Ahora no».

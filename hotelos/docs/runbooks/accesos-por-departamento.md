...
| D4 | Quién corre y quién revisa el cierre del día | `night_auditor` corre; `admin_clerk` (o `accountant` si no hay) revisa a la mañana siguiente; `manager` reabre ≤ 7 días, `controller` > 7 días |
